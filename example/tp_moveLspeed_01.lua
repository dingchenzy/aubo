...
function p_tp_moveLspeed_01()
    ...
    while true do
        ...
        setTcpOffset({0,0,0,0,0,0})
        moveLine(poseTrans(Base, u8defu70b9_1_p), 1.2, 0.25, 0, 0)
